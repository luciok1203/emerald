  ...
  return (
    <>
      <div className="hero-banner">
        <div className="hero-box">4bout OZ</div>
      </div>
        ...
        <ul className={styles.checklist}>
          ...
          <li>
            ...
            <span className={styles.desc}>
              ...
              차단합니다.
              <br />
              해커들이 "OZ가 있는 시스템은 공격할 생각조차 들지 않는다"고
              증언했습니다.
            </span>
          </li>
          <li>
        ...
        <ul className={styles.checklist}>
          ...
          <li>
            ...
            <span className={styles.desc}>
              ...
              활용합니다.
              <br />
              인간의 뇌는 평소 10%만 사용한다는{' '}
              <span className="text-highlight-red">이</span>론에 착안, 나머지
              90%를 시스템 자원으로 전환합니다.
              <br />
              완벽한 지속 가능성: 전기도, 서버도 필요 없습니다. 인간이 곧
              에너지원입니다.
            </span>
          </li>
          <li>
            ...
            <span className={styles.desc}>
              ...
              차단합니다.
              <br />
              직원들은 더 이상 스트레스를 받지 않습니다. 왜냐하면 스트레스를
              느낄 감정 자체가 없으니까요.
            </span>
          </li>
        </ul>
