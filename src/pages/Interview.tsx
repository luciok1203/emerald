...
interface InterviewQuestion extends DataListItem {}

const INTERVIEW_QUESTIONS: InterviewQuestion[] = [
  {
    title: '(주)에메랄드를 설립하게 된 계기는 무엇입니까?',
    content: (
      <>
        ...
        그 어떤 외부의 불순물도 침입할 수 없는 완벽한 보안의 성역. 그것이 바로
        OZ의 시작입니다.
      </>
    ),
  },
  {
    title: "사명을 '에메랄드'로 정하신 특별한 이유가 있나요?",
    content: (
      <>
        ...
        <br />
        <br />
        반면, 에러 색은... 사람을 흥분시킵니다. 피를 끓게 하고, 심박수를 높이고,
        결국엔 시스템을 과열(Overheat)시켜 망가뜨리죠. 우리 회사는 그런 '붉은
        위험'으로부터 여러분의 데이터를, 그리고 여러분의 이성을 지키는
        방벽입니다. 에메랄드는 그 안전의 상징이죠.
        <br />
        <br />이 뜻에 걸맞게 우리 회사는 초록색 눈의 이성적 사고를 권장하고 붉은
        색의 격정과 감정적 사고를 지양하도록 제한 중에 있습니다.
      </>
    ),
  },
  {
    title: '마지막으로 오스카 회장님이 생각하는 에메랄드의 인재상은?',
    content: (
      <>
        ...
        부로서 조용하고 완벽하게 작동할 준비가 된 사람. 만약 당신이 그런 준비가
        되었다면... 환영합니다. 에메랄드 시티의 문은 언제나 열려 있습니다.
      </>
    ),
  },
];
